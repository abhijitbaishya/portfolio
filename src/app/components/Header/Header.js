  ...
  return (
    <React.Fragment>
      ...
      <header
        ...
        style={{
          backgroundColor: isScrolled ? "rgba(60, 60, 60, .9)" : "transparent",
          boxShadow: isScrolled ? "white -10px 25px 50px 10px" : "",
        }}
      >
        <div className="relative">
          <div
            onClick={openDrawer}
            className="z-30 absolute cursor-pointer w-14 h-14 lg:w-24 lg:h-24 bg-black flex justify-center items-center"
          >
          ...
          <ul className="flex font-recoletaBlack flex-row items-center h-24">
            ...
            <li className="group text-2xl relative font-bold mr-20">
              ...
              <a
                ...
                } text-[#b1b1b1] group-hover:text-[#b1b1b1]`}
