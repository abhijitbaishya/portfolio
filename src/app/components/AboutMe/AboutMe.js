  ...
  return (
    <React.Fragment>
      <div
        ...
        className="bg-[#e1e1e3] pt-[250px] mt-4  pb-[100px] lg:pb-[600px] relative lg:h-[800px]"
      >
        <div className="container m-auto">
          <h1 className="text-[240px] w-[80%] overflow-hidden absolute lg:left-40 md:left-30 top-[-50px]  text-[#FFFFFF]">
            About Me
          </h1>
          <h1 className="relative font-recoletaBlack text-5xl  text-[#000000] mb-5 -mt-40  md:px-24 px-5">
            About My Self
          </h1>
          <h4 className="relative w-full font-[300] md:w-3/4 lg:w-2/3 xl:w-1/2 font-recoleta text-[#223740] text-2xl mb-10 px-5 md:px-24">
            Building application with frontend and backend operation
          </h4>
          <section className="relative flex flex-col lg:flex-row px-5 md:px-24">
            ...
            >
              {" "}
              Greetings, My name is Abhijit Baishya. A professional and
              enthusiastic full-stack web3 developer. I've been working and
              learning for the past 5 years and I was continually coming up with
              new concepts. I'm very fluid and never stop learning and adapting
              to new technologies.
            </p>
            <p
              className={`w-full lg:w-1/3 text-[#223740] mr-0 mb-5  lg:mr-4 font-[200] ${hind.className}`}
            >
              ...
              variety of skills, including front-end and back-end development,
              devOps, SEO, server management and many more.
            </p>
            <p
              className={`w-full lg:w-1/3 text-[#223740] mr-0 mb-5  lg:mr-4 font-[200] ${hind.className}`}
            >
      ...
      <div
        style={{
          backgroundImage: "linear-gradient(45deg, #EAF7FC  70%,#223740 30%)",
          width: "100%",
        }}
        className="lg:-mt-60"
      >
        <section className="container flex  flex-col m-auto sm:flex-row px-5 md:px-24 mt-[50px sm:mt-0] transform translate-y-[-100px]">
            ...
            <div className="grid sm:grid-cols-2 xl:grid-cols-3 gap-6 mr-0 lg:mr-10">
              {AboutData.map((item, index) => (
                <a
                  ...
                  style={{ boxShadow: "#444444 -5px  10px 20px 0px" }}
                  className={`relative cursor-pointer transition-all transform duration-300 group center p-6 lg:p-10 flex flex-col justify-center  items-center ${
                    selectedIndex == index
                ...
                >
                  ...
                  <div
                    className={`absolute -top-2 -right-2 transform transition-all duration-500 opacity-0 group-hover:opacity-100 shadow-xl w-12 h-12 bg-[#476571] flex justify-center items-center font-bold text-white font-recoletaBold text-xl  ${
                      selectedIndex === index
          ...
          <div className="w-full sm:w-1/2 lg:w-5/12 overflow-visible px-0 sm:pl-6 xl:px-10">
            <div className="bg-white  lg:mt-0 mt-10 p-10 xl:p-12 shadow-accent-color relative">
              <section
              ...
              >
                <div className="card-inner">
                  <div className="cursor-pointer  text-7xl  xl:text-9xl font-recoletaBlack text-white bg-[#47626D]  p-5 xl:p-8 w-28 h-28 xl:w-48 xl:h-48  transform transition duration-500 transform-preserve -rotate-6 transform-preserve">
              ...
              <div className="absolute right-10  -bottom-5 flex">
                <a
                  onClick={HandlePrev}
                  className="w-12 h-12 mr-1 transform transition duration-500  cursor-pointer  hover:-translate-y-1 hover:shadow-lg -rotate flex justify-center items-center bg-[#47626D]"
                >
                  <svg
